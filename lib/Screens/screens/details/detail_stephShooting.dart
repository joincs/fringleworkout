...
class DetailsStephCurryShootingDrills extends StatelessWidget {
  final User currentUser;
  DetailsStephCurryShootingDrills(this.currentUser);


  String dName = 'Steph Curry\'s Shooting Drills';
  String dCat = 'Shooting';
  String cover = 'asset/detail.png';
  String dDetailImg = 'asset/detailDill.png';
  String video = 'https://www.youtube.com/watch?v=zfyr7ZucMAE';
