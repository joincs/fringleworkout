...
class pendingTransaction extends StatelessWidget {
  ...
  pendingTransaction(this.currentUser);
  ...
  Widget list(BuildContext context, int index, QuerySnapshot data) {
    ...
    child: Column(
                ...
                children: [
                  ...
                  Text('Sending  : ' + data.documents[index]['sendingType'],overflow: TextOverflow.ellipsis,maxLines: 3,
                   ),
                  SizedBox(height: 10,),
                  Text('Receiving: ' +
                      data.documents[index]['receivingType'],overflow: TextOverflow.ellipsis,maxLines: 3,),
                  SizedBox(height: 10,),
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                          data.documents[index]['TransactionReceivingAccount'],overflow: TextOverflow.ellipsis,maxLines: 3,),
                    ],
                  ),
                  SizedBox(height: 10,),
